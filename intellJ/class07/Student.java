...
public class Student {
    ...
    public static void main(String[] args) {
        Student student1=new Student("Puskar",78,98,98);
        student1.printGradeAverage();
        Student student2=new Student("Prakriti",84,89,91);
        student2.printGradeAverage();
        Student student3=new Student("Raj",99,98,96);
        student3.printGradeAverage();
        Student student4=new Student("Prem",87,89,93);
        student4.printGradeAverage();
        Student student5=new Student("Preeti",100,98,100);
